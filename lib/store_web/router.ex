defmodule StoreWeb.Router do
  ...
  scope "/", StoreWeb do
    ...
    live "/groceries/:id/show/order", GroceryLive.Show, :order
  ...
  scope "/", StoreWeb do
    ...
    live "/public/groceries", PublicGroceryLive.Index, :index
    live "/public/groceries/:id", PublicGroceryLive.Show, :show
